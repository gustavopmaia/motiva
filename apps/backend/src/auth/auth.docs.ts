...
import { API_KEY_SOURCES, ApiKeySource } from "./api-key.entity";

export class RegisterRequestDto {
  static readonly validationMessage = "Invalid registration payload.";
...
export class LoginRequestDto {
  static readonly validationMessage = "Invalid login payload.";
...
export class ForgotPasswordRequestDto {
  static readonly validationMessage = "Invalid forgot password payload.";
...
export class ResetPasswordRequestDto {
  static readonly validationMessage = "Invalid reset password payload.";
...
export class CreateApiKeyRequestDto {
  static readonly validationMessage = "Invalid API key payload.";
  ...
  @ApiProperty({
    ...
    enum: API_KEY_SOURCES,
    example: "iot",
  })
  @RequiredEnum(API_KEY_SOURCES)
  source!: ApiKeySource;
}
